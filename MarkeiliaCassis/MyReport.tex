...
\iknow{mv}{this is for renaming files and directories}
\iknow{rm}{this command removes files}
\iknow{rm -r}{this command deletes directories and their contents}
\iknow{ls -a}{this command lists all files and directories}
\iknow{ls -al}{this command shows lists all files and shows permissions, in a drop down list. }
\iknow{ls -l}{this command lists all files that aren't hidden}
\iknow{ssh}{this command connects devices. EX: my laptop to a debian server }
\iknow{ssh-keygen}{this command generates a key }
\iknow{cd}{this command changes the directory}
\iknow{cd ../}{this command takes you back to the previous directory}
\iknow{cd \textasciitilde}{this command takes you to the home directory}
\iknow{echo}{this command repeats the regular expression given }
...
\iknow{chmod}{this command alternates the permissions of a directory and/or file }
\iknow{chown}{this command changes the ownership of a directory or file }
